...
# https://github.com/GandaG/fomod-schema by GandaG
# Slightly modified to include the foseDependency that was added in
# ModuleConfig 5.1 directly, fix a bug that caused lxml to fail to parse it
# (<xs:attribute name="version"> had a leading space in its type) and to wrap
# it in a Python string
# BEGIN MIT-LICENSED PART =====================================================
schema_string = br"""<?xml version="1.0" encoding="utf-8"?>
